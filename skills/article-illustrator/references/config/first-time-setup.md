...
options:
  - label: "Project"
    description: ".yunhe-skills/ (this project only)"
  - label: "User"
    description: "~/.yunhe-skills/ (all projects)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.yunhe-skills/article-illustrator/EXTEND.md` | Current project |
| User | `~/.yunhe-skills/article-illustrator/EXTEND.md` | All projects |
